...
import { faA, faBars, faBuilding, faCaretRight, faCircleInfo, faEnvelope, faMoneyBillTransfer, faSignal, faUser, faUserPlus, faEllipsisVertical } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={`${styles.container}`}>
          <div className={`${styles["head-card"]} card`}>
            <div className={`${styles["head-card-body"]} card-body`}>
              <div className={`d-flex justify-content-between`}>
                ...
                <img src="/clerical-staff.png" className={`${styles["img-head-card"]} me-5`} />
              </div>
          ...
          <div className={`${styles["body-card"]} d-flex justify-content-between mx-3`}>
            <div className={`${styles["card-row-one"]}`}>
              <div class="card mb-2">
                <div class="card-body">
                  <div className={`${styles["card-title"]} d-flex justify-content-between`}>
                    <h3 class="card-title">Employment Status</h3>
                    <FontAwesomeIcon icon={faEllipsisVertical} />
                  </div>
                  <div className={`${styles["progress-bar"]} progress`}>
                    <div className={`${styles["progress1"]} progress-bar`} role="progressbar" aria-label="Segment one" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                    <div className={`${styles["progress2"]} progress-bar`} role="progressbar" aria-label="Segment two" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                    <div className={`${styles["progress3"]} progress-bar`} role="progressbar" aria-label="Segment three" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
              <div class="card">
            ...
            <div className={`${styles["card-row-two"]}`}>
              ...
              <div class="card mb-2">
                <div className={`${styles["card-3-body"]} card-body d-flex justify-content-between`}>
        ...
        <div className={`${styles["canvas"]} offcanvas offcanvas-start`} data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
