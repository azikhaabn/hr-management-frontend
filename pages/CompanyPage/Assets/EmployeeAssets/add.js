...
const ModalAddCompany = ({ closeModal }) => {
  return (
      ...
      <div className={`${styles.modal} modal-content`}>
        ...
        <div className={`${styles.modalBody} modal-body ms-3`}>
          ...
          <div class="me-3 mt-4 mb-5">
            ...
            <div className={`input-group mb-3`}>
              <input type="text" id="description" className={`${styles.inputAssetsCategory} form-control`}></input>
            </div>
          </div>
          ...
          <div class="d-flex justify-content-start">
            <div class="col-4">
              ...
              <div className={`input-group mb-3`}>
                <input type="date" id="landDate" className={`${styles.inputAssetsCategory} form-control`}></input>
              </div>
            </div>
