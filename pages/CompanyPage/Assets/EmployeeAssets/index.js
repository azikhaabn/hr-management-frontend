...
import { faCircleInfo, faXmark, faPenToSquare, faMagnifyingGlass, faAngleRight, faAngleLeft } from "@fortawesome/free-solid-svg-icons";
import { faBars, faEnvelope, faUser } from "@fortawesome/free-regular-svg-icons";
...
export default function CompanyAssets() {
  ...
  return (
    <div className={styles.body}>
            ...
            <section class="section-button-assets">
              <div class="container-fluid mt-4">
                <div class="row align-items-start mt-5 ms-0">
                  <div class="col-lg-4">
                    <button type="button" className={`${styles.btnAssets} btn col-md btn-sm me-1`}>
                      Export Assets
                    </button>
                    <button type="button" className={`${styles.btnAssets} btn col-md btn-sm me-1`}>
                      Import Assets
                    ...
                    <button
                      ...
                      className={`${styles.btnAssets} btn col-md btn-sm`}
                    >
                      Add New
                    </button>
                  </div>
                  ...
                  <table class="table table-hover border-5">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="py-4">T003-Linda Maria</td>
                        <td class="py-4">LAPTOP</td>
                        <td class="py-4">MAC-0123</td>
                        <td class="py-4">Macebook Air</td>
                        <td class="py-4">01/01/2018</td>
                        <td class="py-4">--</td>
                      </tr>
                      <tr>
                        <td class="py-4" scope="row">
                        ...
                        <td class="py-4">T002-Mahmud Derawan</td>
                        <td class="py-4">MOTOR</td>
                        <td class="py-4">MT-001</td>
                        <td class="py-4">Motor Honda Beat</td>
                        <td class="py-4">04/04/2018</td>
                        <td class="py-4">--</td>
                      </tr>
                      <tr>
                        <td class="py-4" scope="row">
      ...
      {openModalEdit && <ModalEdit closeModal={setOpenModalEdit} />}
      {openModalAdd && <ModalAdd closeModal={setOpenModalAdd} />}
