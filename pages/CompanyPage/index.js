      ...
      <main className={styles.main} id="main">
        ...
        <main className={styles.mainContent}>
          ...
          <section className="container text-center">
            ...
            <h2 className="text-uppercase">Zegen Solusi Mandiri</h2>
                ...
                <div className={`row my-2`}>
                  <Link className={`${styles["link-img"]}`} href="/Assets/EmployeeAssets">
                    <div className={`${styles["container"]} col`}>
                      ...
                      <Image className={`${styles["row-img"]} img-fluid`} src="/asset-img.png" width={500} height={300} />
                  ...
                  <Link href="/Reprimand/ReprimandList">
                    <div className={`${styles["container"]} col`}>
                      ...
                      <Image className={`${styles["row-img"]} img-fluid`} src="/reprimand-img.png" width={500} height={300} />
                      <div className={styles.overlay}></div>
                    </div>
                  </Link>
                  <Link href="/CompanyPage/Task/AllTask">
                    <div className={`${styles["container"]} col`}>
                      ...
                      <Image className={`${styles["row-img"]} img-fluid`} src="/task-img.png" width={500} height={300} />
                      <div className={styles.overlay}></div>
                    </div>
                  </Link>
                  <Link href="/Announcement">
                    <div className={`${styles["container"]} col`}>
                      ...
                      <Image className={`${styles["row-img"]} img-fluid`} src="/announce-img.png" width={500} height={300} />
                      <div className={styles.overlay}></div>
                    </div>
                  </Link>
                </div>
                <div className={`row my-2`}>
                  <Link href="/CompanyPage/UserActivityLog">
                    <div className={`${styles["container"]} col`}>
                      ...
                      <Image className={`${styles["row-img"]} img-fluid`} src="/user-activity-log-img.png" width={500} height={300} />
                      <div className={styles.overlay}></div>
                    </div>
                  </Link>
                  <Link href="/CompanyPage/Notification">
                    <div className={`${styles["container"]} col`}>
                      ...
                      <Image className={`${styles["row-img"]} img-fluid`} src="/notification-img.png" width={500} height={300} />
                      <div className={styles.overlay}></div>
                    </div>
                  </Link>
                  <Link href="/CompanyPage/Onboarding/OnProgress">
                    <div className={`${styles["container"]} col`}>
                      ...
                      <Image className={`${styles["row-img"]} img-fluid`} src="/onboarding-img.png" width={500} height={300} />
                      <div className={styles.overlay}></div>
                    </div>
                  </Link>
                  <Link href="/CompanyPage/Files/CompanyFiles">
                    <div className={`${styles["container"]} col`}>
                      ...
                      <Image className={`${styles["row-img"]} img-fluid`} src="/files-img.png" width={500} height={300} />
                      <div className={styles.overlay}></div>
                    </div>
                  </Link>
                </div>
                <div className={`row my-2`}>
                  <Link href="/CompanyPage/Polling/Active">
                    <div className={`col-3`}>
                      ...
                      <Image className={`${styles["row-img"]} img-fluid`} src="/polling-img.png" width={500} height={300} />
                    </div>
                  </Link>
                  <Link href="/CompanyPage/DocumentTemplate">
                    <div className={`col-3`}>
                      <a className={`${styles["text-img"]}`}>Document Template</a>
                      <Image className={`${styles["row-img"]} img-fluid`} src="/document-template-img.png" width={500} height={300} />
                    </div>
                  </Link>
                  <Link href="/CompanyPage/ReportBuilder">
                    <div className={`col-3`}>
                      <a className={`${styles["text-img"]}`}>Report Builder</a>
                      <Image className={`${styles["row-img"]} img-fluid`} src="/report-builder-img.png" width={500} height={300} />
                    </div>
                  </Link>
                </div>
              </div>
